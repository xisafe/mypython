...
fd.columns=['日期','上海融资余额','深圳融资余额','沪深融资余额','上海当日融资买入额','深圳当日融资买入额','沪深当日融资买入额','上海融券余额','深圳融券余额','沪深融券余额','上海融资融券余额','深圳融资融券余额','沪深融资融券余额']
###通过read方法获取返回数据
fd.index=fd['日期']
del fd['日期']
#fd=fd.sort_values(by=['dates'],ascending=True)
fd[['上海融资余额','深圳融资余额','沪深融资余额']].plot(kind='line',secondary_y='price',figsize=(18,6),grid=True)
prices=ts.get_k_data(code='sh',start='2015-01-01')
